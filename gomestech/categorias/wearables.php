<section class="product-description">
    <h2>Descrição</h2>
    <p>Wearables, como smartwatches e pulseiras fitness, monitorizam a saúde, notificações e atividades físicas, integrando tecnologia ao seu dia a dia.</p>
    <h3>Especificações comuns</h3>
    <ul>
        <li>Ecrã: AMOLED ou LCD</li>
        <li>Autonomia: 1 a 14 dias</li>
        <li>Funções: Monitorização cardíaca, GPS, notificações, resistência à água</li>
        <li>Compatibilidade: Android, iOS</li>
        <li>Conectividade: Bluetooth, Wi-Fi</li>
    </ul>
</section>
<?php
session_start();
...
$mysqli = db_connect();
$products = get_produtos_by_categoria($mysqli, 'Wearables');
$mysqli->close();
...
$brand_info = [
    'Apple' => ['icon' => '⌚', 'nome' => 'Apple Watch'],
    'Samsung' => ['icon' => '⌚', 'nome' => 'Galaxy Watch'],
    'Garmin' => ['icon' => '🏃', 'nome' => 'Garmin']
];
?>
<!DOCTYPE html>
<html lang="pt">
<head>
    ...
    <title>Smartwatches - GomesTech</title>
...
<body>
    ...
    <section class="category-hero" style="background: linear-gradient(135deg, #1A1A1D 0%, #FF6A00 100%); padding: 3rem 0; margin-bottom: 3rem; text-align: center;">
        <div class="container">
            <h1 style="font-size: 2.5rem; margin-bottom: 1rem;">⌚ Smartwatches</h1>
            <p style="font-size: 1.2rem; color: var(--text-muted);">Escolha a sua marca favorita</p>
            <?php if($marca_selecionada): ?>
                <a href="wearables.php" class="btn-secondary" style="display: inline-block; margin-top: 1rem;">← Voltar às Marcas</a>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section class="products-section">
        <div class="container">
            ...
            <div style="text-align: center; margin-top: 3rem;">
                <a href="wearables.php" class="btn-secondary">← Voltar às Marcas</a>

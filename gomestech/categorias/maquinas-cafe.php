...
$mysqli = db_connect();
$products = get_produtos_by_categoria($mysqli, 'Máquinas de Café');
$mysqli->close();
?>
<!DOCTYPE html>
<html lang="pt">
<head>
    ...
    <title>Máquinas de Café - GomesTech</title>
...
<body>
    ...
    <section class="category-hero" style="background: linear-gradient(135deg, #1A1A1D 0%, #FF6A00 100%); padding: 3rem 0; margin-bottom: 3rem; text-align: center;">
        <div class="container">
            <h1 style="font-size: 2.5rem; margin-bottom: 1rem;">☕ Máquinas de Café</h1>
            <p style="font-size: 1.2rem; color: var(--text-muted);">Nespresso, De'Longhi, Sage - Automáticas e de cápsulas</p>
        </div>
    </section>

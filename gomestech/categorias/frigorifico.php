...
$mysqli = db_connect();
$products = get_produtos_by_categoria($mysqli, 'Frigoríficos');
$mysqli->close();
?>
<!DOCTYPE html>
<html lang="pt">
<head>
    ...
    <title>Frigoríficos - GomesTech</title>
...
<body>
    ...
    <section class="category-hero" style="background: linear-gradient(135deg, #1A1A1D 0%, #FF6A00 100%); padding: 3rem 0; margin-bottom: 3rem; text-align: center;">
        <div class="container">
            <h1 style="font-size: 2.5rem; margin-bottom: 1rem;">❄️ Frigoríficos</h1>
<section class="product-description">
    <h2>Descrição</h2>
    <p>Frigoríficos mantêm alimentos frescos e bebidas geladas, com diferentes capacidades e tecnologias de conservação.</p>
    <h3>Especificações comuns</h3>
    <ul>
        <li>Capacidade: 200L a 600L</li>
        <li>Tipo: Combinado, Side-by-Side, Uma porta</li>
        <li>Eficiência energética: A++ a D</li>
        <li>Funções: No Frost, congelador rápido, painel digital</li>
        <li>Cor: Branco, inox, preto</li>
    </ul>
</section>
            <p style="font-size: 1.2rem; color: var(--text-muted);">Side by Side, Combinados e mais - Mantém os teus alimentos frescos</p>
        </div>
    </section>

...
$mysqli = db_connect();
$products = get_produtos_by_categoria($mysqli, 'Tablets');
$mysqli->close();
...
$brand_info = [
    'Apple' => ['icon' => '🍎', 'nome' => 'iPad'],
    'Samsung' => ['icon' => '📱', 'nome' => 'Galaxy Tab'],
    'Amazon' => ['icon' => '📦', 'nome' => 'Fire HD']
];
?>
<!DOCTYPE html>
<html lang="pt">
...
<body>
    ...
    <section class="category-hero" style="background: linear-gradient(135deg, #1A1A1D 0%, #FF6A00 100%); padding: 3rem 0; margin-bottom: 3rem; text-align: center;">
        <div class="container">
            <h1 style="font-size: 2.5rem; margin-bottom: 1rem;">📱 Tablets</h1>
<section class="product-description">
    <h2>Descrição</h2>
    <p>Tablets são dispositivos versáteis para navegação, leitura, estudo e entretenimento, combinando portabilidade e desempenho.</p>
    <h3>Especificações comuns</h3>
    <ul>
        <li>Ecrã: 8" a 12.9" IPS ou AMOLED</li>
        <li>Processador: Quad-core ou superior</li>
        <li>Memória RAM: 3GB a 8GB</li>
        <li>Armazenamento: 32GB a 256GB</li>
        <li>Sistema Operativo: Android, iOS, Windows</li>
        <li>Bateria: 4000mAh a 10000mAh</li>
    </ul>
</section>
            <p style="font-size: 1.2rem; color: var(--text-muted);">Escolha a sua marca favorita</p>
            <?php if($marca_selecionada): ?>
                <a href="tablets.php" class="btn-secondary" style="display: inline-block; margin-top: 1rem;">← Voltar às Marcas</a>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section class="products-section">
        <div class="container">
            ...
            <div style="text-align: center; margin-top: 3rem;">
                <a href="tablets.php" class="btn-secondary">← Voltar às Marcas</a>

...
$mysqli = db_connect();
$products = get_produtos_by_categoria($mysqli, 'Laptops');
$mysqli->close();
...
$brand_info = [
    'Apple' => ['icon' => '🍎', 'nome' => 'MacBook'],
    'Dell' => ['icon' => '💻', 'nome' => 'Dell XPS'],
    'Lenovo' => ['icon' => '🔧', 'nome' => 'Lenovo ThinkPad'],
    'HP' => ['icon' => '🖥️', 'nome' => 'HP'],
    'Asus' => ['icon' => '🎮', 'nome' => 'Asus ROG'],
    'MSI' => ['icon' => '⚡', 'nome' => 'MSI']
];
?>
<!DOCTYPE html>
...
<body>
    ...
    <section class="category-hero" style="background: linear-gradient(135deg, #1A1A1D 0%, #FF6A00 100%); padding: 3rem 0; margin-bottom: 3rem; text-align: center;">
        <div class="container">
            <h1 style="font-size: 2.5rem; margin-bottom: 1rem;">💻 Laptops</h1>
<section class="product-description">
    <h2>Descrição</h2>
    <p>Laptops são computadores portáteis ideais para trabalho, estudo e lazer, oferecendo mobilidade e desempenho.</p>
    <h3>Especificações comuns</h3>
    <ul>
        <li>Ecrã: 14" a 16" Full HD ou superior</li>
        <li>Processador: Intel Core i5/i7 ou AMD Ryzen 5/7</li>
        <li>Memória RAM: 8GB a 32GB</li>
        <li>Armazenamento: SSD 256GB a 1TB</li>
        <li>Placa Gráfica: Integrada ou dedicada (NVIDIA/AMD)</li>
        <li>Sistema Operativo: Windows, macOS ou Linux</li>
    </ul>
</section>
            <p style="font-size: 1.2rem; color: var(--text-muted);">Escolha a sua marca favorita</p>
            <?php if($marca_selecionada): ?>
                <a href="laptops.php" class="btn-secondary" style="display: inline-block; margin-top: 1rem;">← Voltar às Marcas</a>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section class="products-section">
        <div class="container">
            ...
            <div style="text-align: center; margin-top: 3rem;">
                <a href="laptops.php" class="btn-secondary">← Voltar às Marcas</a>

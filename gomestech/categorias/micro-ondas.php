<section class="product-description">
    <h2>Descrição</h2>
    <p>Os micro-ondas são eletrodomésticos práticos para aquecer, descongelar e cozinhar alimentos de forma rápida e eficiente.</p>
    <h3>Especificações comuns</h3>
    <ul>
        <li>Capacidade: 17L a 32L</li>
        <li>Potência: 700W a 1200W</li>
        <li>Funções: Grill, descongelação, programas automáticos</li>
        <li>Painel: Analógico ou digital</li>
        <li>Cor: Branco, inox, preto</li>
    </ul>
</section>
<?php
session_start();
...
$mysqli = db_connect();
$products = get_produtos_by_categoria($mysqli, 'Micro-ondas');
$mysqli->close();
?>
<!DOCTYPE html>
<html lang="pt">
<head>
    ...
    <title>Micro-ondas - GomesTech</title>
...
<body>
    ...
    <section class="category-hero" style="background: linear-gradient(135deg, #1A1A1D 0%, #FF6A00 100%); padding: 3rem 0; margin-bottom: 3rem; text-align: center;">
        <div class="container">
            <h1 style="font-size: 2.5rem; margin-bottom: 1rem;">🔥 Micro-ondas</h1>
            <p style="font-size: 1.2rem; color: var(--text-muted);">Samsung, Panasonic, Whirlpool - Aquece e cozinha rapidamente</p>
        </div>
    </section>

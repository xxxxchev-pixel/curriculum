...
$catalogo_data = json_decode(file_get_contents($json_file), true);
$produtos = $catalogo_data['produtos'] ?? [];
...
$produtos_promocao = count(array_filter($produtos, fn($p) => $p['promocao'] ?? false));
    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="promocoes.php" class="nav-item">
                    <span class="i">🎁</span> Promoções
                </a>
